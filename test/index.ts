...
describe('getDaysToNewYear', () => {
    ...
    it('should return 71 for given input "22.10.2021"', () => {
        assert.strictEqual(getDaysToNewYear('22.10.2021'), 71);
    });

    it('should return 608 for given input "03.05.2020"', () => {
        assert.strictEqual(getDaysToNewYear('03.05.2020'), 608);
    });
    ...
    it('should return 200 for given input new Date(2021, 5, 15)', () => {
        assert.strictEqual(getDaysToNewYear(new Date(2021, 5, 15)), 200);
    });

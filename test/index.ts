...
describe('getDaysToNewYear', () => {
    ...
    it('should return 1 for given input "31.12.2020"', () => {
        assert.strictEqual(getDaysToNewYear('31.12.2020'), 1);
    });

    it('should return 71 for given input "22.10.2020"', () => {
        assert.strictEqual(getDaysToNewYear('22.10.2020'), 71);
    });

    it('should return 609 for given input "03.05.2019"', () => {
        assert.strictEqual(getDaysToNewYear('03.05.2019'), 609);
    });

    it('should return 1 for given input new Date("12-31-2020")', () => {
        assert.strictEqual(getDaysToNewYear(new Date('12-31-2020')), 1);
    });

    it('should return 200 for given input new Date(2020, 5, 15)', () => {
        assert.strictEqual(getDaysToNewYear(new Date(2020, 5, 15)), 200);
    });

    it('should return 3221 for given input new Date(2012, 2, 8)', () => {
        assert.strictEqual(getDaysToNewYear(new Date(2012, 2, 8)), 3221);
    });
